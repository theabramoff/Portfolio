...
Get-AzVM -Status | `
Where-Object {$_.StorageProfile.OsDisk.OsType -eq "Windows" -and $_.LicenseType -ne "Windows_Server" -and $_.Powerstate -eq "VM running" }  | `
Select-Object -Property Name, `
@{Label="VmSize";Expression={$_.HardwareProfile.VmSize}}, `
@{Label="OsType";Expression={$_.StorageProfile.OsDisk.OsType}}, `
