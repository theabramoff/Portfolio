...
# The script allows to dump idle Azure DevOps lincesed from Basic and Basic + Test Plan for everyone who has not access an organization for 2 months. It works within single organization where a PAT token has access
# Required:
